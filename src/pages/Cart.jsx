...
function Cart({ cartItems, setCartItems }) {
  ...
  const removeFromCart = async (productId) => {
    try {
      ...
      const response = await api.delete(`/api/products/cart/${productId}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
  ...
  const clearCart = async () => {
    try {
      ...
      await api.delete("/api/products/cart", {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      });
              ...
              return (
                <div className="cart-item" key={product._id}>
                  ...
                  <div className="cart-quantity">
                    <button
                      type="button"
                      onClick={() => decreaseQuantity(product._id, quantity)}
                    >
                      <Minus size={16} />
                    </button>
                    ...
                    <button
                      type="button"
                      onClick={() => increaseQuantity(product._id, quantity)}
                    >
                      <Plus size={16} />
                    </button>
                  </div>
